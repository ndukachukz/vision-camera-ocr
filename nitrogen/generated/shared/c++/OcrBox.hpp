...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::chuksdengr::ocr::OcrBox> final {
    static inline margelo::nitro::chuksdengr::ocr::OcrBox fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::chuksdengr::ocr::OcrBox(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::chuksdengr::ocr::OcrBox& arg) {
